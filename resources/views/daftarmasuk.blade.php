  ...
  <style>
    ...
    .btn {
      ...
      font-size: 16px;
        ...
        /* Styles for button after click */
    .btn.clicked 
    {
      background-color: #f44336; /* Color after click */
    }
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div class="judul"><h3>DATA PENDAFTARAN MASUK</h3></div>
    <hr>
    <table>
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img src="{{ asset('asset/img/' . $pendaftaran->foto) }}" alt="Foto {{ $pendaftaran->nama }}" width="100"></td>
            <td><a href="/acc"><button class="btn" id="myButton">Tinjau</button></a></td>
        </tr>
        @endforeach
    </tbody>
</table>
